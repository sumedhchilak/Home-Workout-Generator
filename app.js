...
//Recieves User Data from the form
function formData(){
  ...
  // Stores the user data as a JSON string to be stored in local storage
...
function createWorkoutPage(){
  // Information stored again after parsing the JSON string that was stored in local storage
